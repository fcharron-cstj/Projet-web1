...
<div class="container">
    ...
    <main>
        ...
        <div class="content">
            <section>
                <h2>À propos</h2>
                <p>Bienvenue chez Pub G6, un établissement emblématique qui a su séduire les gourmets depuis sa
                    fondation il
                    y a
                    20 ans. Niché au cœur de notre charmante ville, notre restaurant propose une expérience culinaire
                    unique,
                    alliant tradition et innovation. Chaque plat est préparé avec des ingrédients frais et locaux,
                    reflétant
                    notre engagement envers la qualité et l'authenticité.</p>
                <img src="" alt="">
                <p>Au fil des années, Pub G6 est devenu un lieu de rencontre incontournable pour les amoureux de la
                    bonne
                    cuisine. Notre équipe passionnée et talentueuse, dirigée par notre chef renommé, met un point
                    d'honneur
                    à
                    offrir un service chaleureux et attentif. Que vous veniez pour un dîner romantique, une réunion
                    entre
                    amis
                    ou un événement spécial, notre atmosphère conviviale et élégante vous accueillera toujours avec
                    plaisir.
                </p>
                <img src="" alt="">
                <p>Nous sommes fiers de notre héritage et de notre évolution constante. En célébrant deux décennies de
                    succès,
                    nous continuons à innover et à réinventer nos menus pour surprendre et ravir nos clients fidèles.
                    Venez
                    découvrir pourquoi le Bistro du Vieux-Port est une véritable institution culinaire, où chaque visite
                    est
                    une
            ...
            <div id="careers">
                ...
                <b>Qui Sommes-Nous ?</b>
                <p>Le Pub G6 est un restaurant de style pub renommé, où la tradition rencontre l'innovation culinaire.
                    Nous
                    offrons
                    une expérience unique à nos clients grâce à notre atmosphère chaleureuse, notre service exceptionnel
                    et
                    nos
                    plats créatifs.</p>

                <b>Pourquoi Travailler avec Nous ?</b>
                <p>Environnement de Travail Positif : Rejoignez une équipe où l'entraide, la bonne humeur et la passion
                    pour
                    la
                    cuisine sont au cœur de nos valeurs.
                    Opportunités de Carrière : Nous croyons en la promotion interne et offrons de nombreuses
                    opportunités de
                    développement professionnel.
                    Formation Continue : Que vous soyez débutant ou expérimenté, nous vous offrons des formations
                    régulières
                    pour
                ...
                <b> Envoyez-nous votre CV et une lettre de motivation à email@pubG6.com. Nous avons hâte de découvrir ce
                    que
                    vous

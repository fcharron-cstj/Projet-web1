...
<main>
    ...
    <section>
        <p>Bienvenue chez Pub G6, un établissement emblématique qui a su séduire les gourmets depuis sa fondation il y a
            20 ans. Niché au cœur de notre charmante ville, notre restaurant propose une expérience culinaire unique,
        ...
        <p>Au fil des années, Pub G6 est devenu un lieu de rencontre incontournable pour les amoureux de la bonne
            cuisine. Notre équipe passionnée et talentueuse, dirigée par notre chef renommé, met un point d'honneur à
            offrir un service chaleureux et attentif. Que vous veniez pour un dîner romantique, une réunion entre amis
            ou un événement spécial, notre atmosphère conviviale et élégante vous accueillera toujours avec plaisir.</p>
        <div class="line"></div>
        <img src="" alt="">
        <p>Nous sommes fiers de notre héritage et de notre évolution constante. En célébrant deux décennies de succès,
            nous continuons à innover et à réinventer nos menus pour surprendre et ravir nos clients fidèles. Venez
            découvrir pourquoi le Bistro du Vieux-Port est une véritable institution culinaire, où chaque visite est une
    ...
    <div id="careers">
        ...
        <p>Vous cherchez à faire partie d'une équipe passionnée dans un environnement convivial et dynamique ? Le Pub G6
            est
        ...
        <p>Le Pub G6 est un restaurant de style pub renommé, où la tradition rencontre l'innovation culinaire. Nous
            offrons
            une expérience unique à nos clients grâce à notre atmosphère chaleureuse, notre service exceptionnel et nos
            plats créatifs.</p>

        <b>Pourquoi Travailler avec Nous ?</b>
        <p>Environnement de Travail Positif : Rejoignez une équipe où l'entraide, la bonne humeur et la passion pour la
            ...
            Avantages Attrayants : Profitez de repas offerts pendant vos shifts, de réductions pour vos amis et votre
